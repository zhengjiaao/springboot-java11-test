...
public class Example {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //同步与异步请求
        syncGet("https://www.baidu.com/");
//        asyncGet("https://www.baidu.com/");
//        asyncPost();
...
//        http2();
        ...
        //并行请求
//        List<URI> uris = List.of(URI.create("https://www.baidu.com/"), URI.create("https://www.baidu.com/"));
//        getURIs(uris);
...
//        basicAuth();
    ...
    public static void asyncPost() throws Exception {
        ...
        Foo foo = new Foo();
        foo.name = "zhengja";
        foo.url = "https://github.com/zhengja";
    ...
    // 并行请求
    public static void getURIs(List<URI> uris) {
        HttpClient client = HttpClient.newHttpClient();
